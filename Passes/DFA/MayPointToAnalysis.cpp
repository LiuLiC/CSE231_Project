  ...
  void flowfunction(Instruction * I,
    ...
    if(isa<AllocaInst>(I)){
      ...
      GetElementPtrInst * instr = cast<GetElementPtrInst> (I);
			unsigned rv = instrToIndex[(Instruction *) instr->getPointerOperand()];
      set<unsigned> X = inInfo->getMemSet(make_pair(R, rv));
...
static RegisterPass<MayPointToAnalysisPass> X("cse231-maypointto", "Do maypointto analysis on DFA CFG", false, false);